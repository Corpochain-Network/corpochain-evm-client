...
//
// This is useful if a corpochain blockchain is feeding us large chunks of payloads to run,
...
func (d *Downloader) findBeaconAncestor() (uint64, error) {
	...
	if !linked {
		...
		// races with the user (or corpochain blockchain) calling setHead. Whilst panic
